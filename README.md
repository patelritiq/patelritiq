# Hi there, I'm Ritik Pratap Singh Patel 👋
...
- 💼 Graduate Engineer Trainee at MPSEDC - State IT Center, Bhopal
- 🎓 B.Tech in Computer Science from RGPV (8.77 CGPA)
- 📝 I regularly write on [my blog](https://patelritiq.blogspot.com)
...
### 📊 Data Analytics & ML
- **[DS_Assignment_Zeotap](https://github.com/patelritiq/DS_Assignment_Zeotap)** - Customer analytics & segmentation using K-Means clustering (200 customers, 1,000 transactions, 5 clusters)
- **[Government-Scheme-MSME-Analytics](https://github.com/patelritiq/Government-Scheme-MSME-Analytics-MPSEDC)** - State-level analytics dashboard with Power BI (19,288 records, 50+ districts)
- **[SmartFace-Attendance](https://github.com/patelritiq/SmartFace-Attendance)** - Real-time face recognition system using OpenCV & KNN (100+ samples per user)

### 🌐 Full-Stack Development
- **[my-first-web-application](https://github.com/patelritiq/my-first-web-application)** - Student Management System with Angular + ASP.NET Core (CRUD operations, 29 states)
- **[CodeClause-Internship-Projects](https://github.com/patelritiq/CodeClause-Internship-Projects)** - 4 Python applications (Flask, NiceGUI, Tkinter)

### 🎮 Game Development
- **[Balloon-Buster-2.0](https://github.com/patelritiq/Balloon-Buster-2.0)** - Modern C++17 arcade game with structured game engine (3 levels + survival mode)
...
**Graduate Engineer Trainee** @ MPSEDC (Nov 2025 - Present)
- Working on live government web applications serving lakhs of users
- Contributing to maintenance, feature development, and module enhancement
- Collaborating with senior engineers on DB logic and CI/CD deployments

**Internships:**
- Machine Learning Virtual Intern @ AspireNex (Jul-Sep 2024)
- Python Development Intern @ Sudaku CodeClause (Jun-Jul 2024)
- Data Science & Analytics Intern @ Zidio Development (Apr-May 2024)

## 📌 Highlights

- 🎓 B.Tech in Computer Science with **8.77 CGPA**
- 📊 Built analytics dashboard processing **19,288+ records**
- 🤖 Developed ML models on datasets with **20K-280K records**
- 👥 Created **SmartFace Attendance** with **100+ face samples per user**
...
- 🔨 Building and enhancing scalable government web applications
- 📊 Exploring advanced data analytics and visualization techniques
- 🤖 Deepening knowledge in machine learning and computer vision
- 🌐 Enhancing full-stack development skills
- 📝 Writing technical blogs and sharing knowledge

## 💡 Interests

⚽ Football | 🎬 Cinema | 🏏 Cricket | 📚 Literature | ✍️ Content Creation
