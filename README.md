...
Software Engineer working on **large-scale government web applications at MPSEDC** used by lakhs of citizens across Madhya Pradesh.  
I enjoy building **data-driven systems, machine learning models, analytics dashboards, and full-stack applications**.
...
**[Government Scheme & MSME Analytics](https://github.com/patelritiq/Government-Scheme-MSME-Analytics-MPSEDC)**  
State-level analytics dashboard built with **Power BI + Python** analyzing **19,288+ records across 50+ districts** to monitor welfare schemes and MSME growth.

**[SmartFace Attendance](https://github.com/patelritiq/SmartFace-Attendance)**  
Real-time **face recognition attendance system** using OpenCV & KNN with **100+ samples per user** and automated CSV attendance logging.

**[DS Assignment – Zeotap](https://github.com/patelritiq/DS_Assignment_Zeotap)**  
Customer segmentation system using **K-Means clustering** on behavioral transaction data to identify 5 customer clusters.

---

### 🌐 Full-Stack Development

**[Student Management System](https://github.com/patelritiq/my-first-web-application)**  
Full-stack web application built with **Angular + ASP.NET Core** implementing CRUD operations and state-wise student management.

**[CodeClause Internship Projects](https://github.com/patelritiq/CodeClause-Internship-Projects)**  
Collection of **4 Python applications** built during internship including Flask web apps, GUI tools, and authentication systems.
...
- Working in **Agile SDLC with CI/CD deployments**
